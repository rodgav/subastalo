...
class MiPagosPage extends StatelessWidget {
  final logic = Get.find<MiPagosLogic>();

   MiPagosPage({Key? key}) : super(key: key);
              ...
              children: [
                Column(
                  ...
                  children: const [
                    ...
                    Text('Aquí podrás gestionar tus pagos',
                        style: TextStyle(fontSize: 12)),
                  ],
                ),
                const Divider(height: 20),
                GetBuilder<MiPagosLogic>(
                    id: 'pagos',
                    builder: (_) {
