...
class EditUsuario extends StatelessWidget {
  final int idUser;

  const EditUsuario(this.idUser, {Key? key}) : super(key: key);
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Center(
                child: Text(
                  'Aquí podrás editar los usuarios.',
              ...
              TxtFieldBor(
                  controller: _.editFullNameCtrl,
                  validator: isNotEmpty,
                  width: 400,
                  hint: 'Ingresar nombre completo y apellidos',
                  icon: null,
              ...
              const SizedBox(height: 5),
              TxtFieldBor(
                  controller: _.editPassword1Ctrl,
              ...
              const SizedBox(height: 5),
              TxtFieldBor(
                  controller: _.editPassword2Ctrl,
                  validator: isPassword,
                  width: 400,
              ...
              ButtonWid(
                  ...
                  voidCallback: () => _.editSaveUsuario(idUser))
            ],
          ),
        ),
      );
