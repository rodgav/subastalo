...
class EditCampana extends StatelessWidget {
  final int idCampa;

  const EditCampana(this.idCampa, {Key? key}) : super(key: key);
            ...
            child: Column(
              ...
              children: [
                ...
                TxtFieldBor(
                    ...
                    controller: _.editNameCompanCtrl,
                    width: 400,
                    hint: '',
                    icon: null,
                ...
                TxtFieldBor(
                    validator: isNotEmpty,
                    controller: _.editAmmountDescCtrl,
                    width: 400,
                    hint: '',
                    icon: null,
                    enabledBorder: ColorsUtils.grey1.withOpacity(0.5),
                ...
                ButtonWid(
                    ...
                    voidCallback: ()=>_.saveEditCampana(idCampa))
              ],
            ),
          ),
        );
