...
import 'package:subastalo/app/modules/subastas_detail/subastas_detail_logic.dart';
import 'package:subastalo/utils/colors_utils.dart';

class SubastaEnVivo extends StatelessWidget {
  const SubastaEnVivo({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SubastasDetailLogic>(builder: (_) {
      return Scaffold(
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Center(
                            child: SizedBox(
                              width: web ? (size.width / 2) / 2 : size.width /
                                  2,
                              height: 50,
                              child: Stack(
                                children: [
